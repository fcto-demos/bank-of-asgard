...
echo ""
echo "  Status:"
echo "    sudo systemctl status bank-of-asgard-api"
echo "    sudo systemctl status bank-of-asgard-server"
echo "    sudo systemctl status bank-of-asgard-agent"
echo "    sudo systemctl status bank-of-asgard-app"
echo ""
echo "  Logs (live):"
echo "    journalctl -u bank-of-asgard-api    -f"
echo "    journalctl -u bank-of-asgard-server -f"
echo "    journalctl -u bank-of-asgard-agent  -f"
echo "    journalctl -u bank-of-asgard-app    -f"
